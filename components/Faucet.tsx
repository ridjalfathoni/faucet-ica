    ...
    <>
      <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          <div>
            <img className="mx-auto h-12 w-auto" src="logo.png" alt="ICA Faucet" />
            <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">ICA Faucet</h2>
          </div>
